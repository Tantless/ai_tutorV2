...
- 
eynman ??? 	opic_id
- consolidation_practice / extra_practice ???? 	opic_id
- ??????????????????????????????????????consolidation_practice -> extra_practice -> 
eynman
- ?????????????????? estimated_score
- supplementary_reward_count ?????????????????????????????? 5 ?
- 
esolved_weak_points ?????????????????????????????????????? ctive_weak_points ??
- 
eynman / consolidation_practice / extra_practice / hidden_challenge ??? knowledge_mastery
- 
eynman / consolidation_practice / extra_practice / hidden_challenge ??? weak_points_history
## 10. 一致性规则
